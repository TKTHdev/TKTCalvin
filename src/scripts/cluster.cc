...
DEFINE_string(ssh_key1, "-i ~/.ssh/id_rsa.pub", "ssh_key for the first data center(Virginia)");
DEFINE_string(ssh_key2, "-i ~/.ssh/id_rsa.pub", "ssh_key for the second data center(Oregon)");
DEFINE_string(ssh_key3, "-i ~/.ssh/id_rsa.pub", "ssh_key for the third data center(Ireland)");
DEFINE_string(ssh_key4, "-i ~/.ssh/id_rsa.pub", "ssh_key for the first data center(Virginia)");
DEFINE_string(ssh_key5, "-i ~/.ssh/id_rsa.pub", "ssh_key for the second data center(Oregon)");
DEFINE_string(ssh_key6, "-i ~/.ssh/id_rsa.pub", "ssh_key for the third data center(Ireland)");
